...
import unseen from '../../assets/icons/unseen.jpg'
import tech from '../../assets/icons/3.jpg'
import austin from '../../assets/icons/austin.jpg'
import digital from '../../assets/icons/digital.jpg'
    ...
    <main className='services-page'>
      ...
      <div className="services">
        ...
        <div className="card">
          ...
          <p>Leveraging our expertise in finance and investment, we provide comprehensive financial consultancy services tailored to the unique needs of each client. From financial planning and investment advisory to risk management and mergers and acquisitions consulting, we help businesses navigate complex financial landscapes and achieve their goals.</p>
        </div>

        <div className="card">
          <img src={unseen} alt="" />
          <h1>PROFESSIONAL &<br />ACADEMIC WRITING</h1>
          <p>Our team of skilled writers and editors specializes in crafting compelling content for both professional and academic purposes. Whether it's business reports, marketing materials, academic papers, or technical documentation, wedeliver polished and engaging content that resonates with audiences and drives results.</p>
        </div>

        <div className="card">
          <img src={digital} alt="" />
          <h1>REAL ESTATE</h1>
          <p>In the realm of real estate, we offer a range of services including property management, brokerage, investment analysis, and leasing. With our in-depth market knowledge and strategic insights, we assist clients in finding the perfect real estate solutions that align with their business objectives and drive growth.</p>
        </div>
